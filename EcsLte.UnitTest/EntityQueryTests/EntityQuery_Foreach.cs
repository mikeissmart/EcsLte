...
{
    [TestClass]
    public class EntityQuery_Foreach : BasePrePostTest
    {
        ...
        private int _refChangeAmount = 10;
        ...
        public void ForEach_Read_0_Write_5()
        {
            ...
            for (var i = 0; i < entities.Length; i++)
            {
                ...
                Assert.IsTrue(Context.GetComponent<TestComponent4>(entity).Prop == _component4.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
                Assert.IsTrue(Context.GetComponent<TestComponent5>(entity).Prop == _component5.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
            }
        }
        ...
        public void ForEach_Read_0_Write_6()
        {
            ...
            for (var i = 0; i < entities.Length; i++)
            {
                ...
                Assert.IsTrue(Context.GetComponent<TestComponent5>(entity).Prop == _component5.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
                Assert.IsTrue(Context.GetComponent<TestComponent6>(entity).Prop == _component6.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
            }
        }
        ...
        public void ForEach_Read_0_Write_7()
        {
            ...
            for (var i = 0; i < entities.Length; i++)
            {
                ...
                Assert.IsTrue(Context.GetComponent<TestComponent6>(entity).Prop == _component6.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
                Assert.IsTrue(Context.GetComponent<TestComponent7>(entity).Prop == _component7.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
            }
        }
        ...
        public void ForEach_Read_0_Write_8()
        {
            ...
            for (var i = 0; i < entities.Length; i++)
            {
                ...
                Assert.IsTrue(Context.GetComponent<TestComponent7>(entity).Prop == _component7.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
                Assert.IsTrue(Context.GetComponent<TestComponent8>(entity).Prop == _component8.Prop + _refChangeAmount,
                    $"Enity.Id {entities[i].Id}");
            }
        }
        ...
        private Entity[] CreateEntities_x8()
        {
            return Context.CreateEntities(UnitTestConsts.SmallCount, new EntityBlueprint()
        ...
        private EntityQuery CreateQuery_x8()
        {
