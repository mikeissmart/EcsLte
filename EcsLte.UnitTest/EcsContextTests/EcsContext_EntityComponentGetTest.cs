...
{
    [TestClass]
    public class EcsContext_EntityComponentGetTest : BasePrePostTest, IEntityComponentGetTest
    {
        private TestComponent1 _testComponent1 = new TestComponent1 { Prop = 1 };
        private TestSharedComponent1 _testSharedComponent1 = new TestSharedComponent1 { Prop = 2 };
        private TestUniqueComponent1 _testUniqueComponent1 = new TestUniqueComponent1 { Prop = 3 };
        ...
        public void GetComponent_Normal_Never()
        {
            var entity = Context.CreateEntity(new EntityBlueprint()
                .AddComponent(_testSharedComponent1));

            Assert.ThrowsException<EntityNotHaveComponentException>(() =>
                Context.GetComponent<TestComponent1>(entity));
        }
        ...
        {
            var entity = Context.CreateEntity(new EntityBlueprint()
                .AddComponent(_testUniqueComponent1));

            Assert.ThrowsException<EntityNotHaveComponentException>(() =>
                Context.GetComponent<TestSharedComponent1>(entity));
        }
        ...
        {
            var entity = Context.CreateEntity(new EntityBlueprint()
                .AddComponent(_testComponent1));

            Assert.ThrowsException<EntityNotHaveComponentException>(() =>
                Context.GetComponent<TestUniqueComponent1>(entity));
        }
