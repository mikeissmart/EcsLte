...
{
    internal class EntityCommandPlayback_EntityComponent_RemoveComponent : BasePerformanceTest
    {
        ...
        {
            for (var i = 0; i < TestConsts.EntityLoopCount; i++)
                _world.EntityManager.DefaultEntityCommandPlayback.RemoveComponent<TestComponent1>(_entities[i]);
        ...
        public override void RunParallel()
        {
            ParallelRunner.RunParallelFor(TestConsts.EntityLoopCount,
                index =>
                {
                    _world.EntityManager.DefaultEntityCommandPlayback.RemoveComponent<TestComponent1>(_entities[index]);
                });
            _world.EntityManager.DefaultEntityCommandPlayback.RunCommands();
        }
