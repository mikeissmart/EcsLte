...
{
	internal class EcsContext_ComponentLife_ReplaceComponent_Standard : BasePerformanceTest
	{
		...
		public override void Run()
		{
			var component = new TestStandardComponent1();
			for (var i = 0; i < TestConsts.EntityLoopCount; i++)
				_context.ReplaceComponent(_entities[i], component);
		}
		...
		public override void RunParallel()
		{
			...
			ParallelRunner.RunParallelFor(TestConsts.EntityLoopCount,
				i => { _context.ReplaceComponent(_entities[i], component); });
		}
	}
}