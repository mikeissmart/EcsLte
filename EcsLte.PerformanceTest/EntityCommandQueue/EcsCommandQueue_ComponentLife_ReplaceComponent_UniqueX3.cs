...
{
	internal class EntityCommandQueue_ComponentLife_ReplaceComponent_UniqueX3 : BasePerformanceTest
	{
		...
		public override void Run()
		{
			for (var i = 0; i < TestConsts.EntityLoopCount; i++)
			{
				...
				_context.DefaultCommand.ReplaceUniqueComponent(_entity, _component3);
			}
