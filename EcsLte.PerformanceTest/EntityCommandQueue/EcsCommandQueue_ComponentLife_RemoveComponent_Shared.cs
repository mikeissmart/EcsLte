...
{
    internal class EntityCommandQueue_ComponentLife_RemoveComponent_Shared : BasePerformanceTest
    {
        ...
        public override void RunParallel()
        {
            ParallelRunner.RunParallelFor(TestConsts.EntityLoopCount,
                i => { _context.DefaultCommand.RemoveComponent<TestSharedComponent1>(_entities[i]); });
            _context.DefaultCommand.RunCommands();
        }
    }
}