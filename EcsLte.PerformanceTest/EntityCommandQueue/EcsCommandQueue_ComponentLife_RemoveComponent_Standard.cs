...
{
    internal class EntityCommandQueue_ComponentLife_RemoveComponent_Standard : BasePerformanceTest
    {
        ...
        public override void RunParallel()
        {
            ParallelRunner.RunParallelFor(TestConsts.EntityLoopCount,
                i => { _context.DefaultCommand.RemoveComponent<TestStandardComponent1>(_entities[i]); });
            _context.DefaultCommand.RunCommands();
        }
    }
}