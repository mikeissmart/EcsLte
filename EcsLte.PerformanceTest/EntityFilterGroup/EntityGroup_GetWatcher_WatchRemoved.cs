...
{
	internal class EntityFilterGroup_GetWatcher_WatchRemoved : BasePerformanceTest
	{
		...
		public override void Run()
		{
			...
			for (var i = 0; i < TestConsts.EntityLoopCount; i++)
				watcher = _entityFilterGroup.WatchRemoved(_filter);
		}
		...
		public override void RunParallel()
		{
			...
			ParallelRunner.RunParallelFor(TestConsts.EntityLoopCount,
				i => { watcher = _entityFilterGroup.WatchRemoved(_filter); });
		}
	}
}