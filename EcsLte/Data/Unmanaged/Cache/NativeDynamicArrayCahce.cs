...
namespace EcsLte.Data.Unmanaged.Cache
{
    public class NativeDynamicArrayCahce : BaseNativeCacheManager<NativeDynamicArray>
    {
        ...
        private static NativeDynamicArray Alloc() => NativeDynamicArray.Alloc(EcsSettings.UnmanagedDataChunkInBytes);

        public static void Free(NativeDynamicArray array) => array.Dispose();
    }
}
