...
namespace EcsLte
{
    public class EntityQuery_ArcheType : IEntityQuery
    {
        ...
        internal EntityQueryData_ArcheType Data { get; set; }

        internal EntityQuery_ArcheType(IComponentEntityFactory componentEntityFactory) => Data = new EntityQueryData_ArcheType(componentEntityFactory);

        private EntityQuery_ArcheType(EntityQuery_ArcheType query, EntityQueryCategory category, ComponentConfig config) : this(query.Data.ComponentEntityFactory)
        {
            if (config.IsUnique)
        ...
        private EntityQuery_ArcheType(EntityQuery_ArcheType query, EntityQueryCategory category, ComponentConfig[] configs) : this(query.Data.ComponentEntityFactory)
        {
        ...
        private EntityQuery_ArcheType(EntityQuery_ArcheType query, EntityQueryCategory category, ComponentConfig config, SharedComponentDataIndex sharedComponent) : this(query.Data.ComponentEntityFactory)
        {
            CheckDistinctConfig(query.Data.AnyConfigs, config);
            CheckDistinctConfig(query.Data.NoneConfigs, config);
        ...
        private EntityQuery_ArcheType(EntityQuery_ArcheType query, EntityQueryCategory category, ComponentConfig[] configs, SharedComponentDataIndex[] sharedComponents) : this(query.Data.ComponentEntityFactory)
        {
            CheckDuplicateConfigs(configs);
            CheckDistinctConfigs(query.Data.AnyConfigs, configs);
            CheckDistinctConfigs(query.Data.NoneConfigs, configs);
            CheckDistinctShareComponents(Data.SharedComponents, sharedComponents);
        ...
        public IEntityQuery WhereAllOf<T1>()
            where T1 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All, ComponentConfig<T1>.Config);

        public IEntityQuery WhereAllOf<T1, T2>()
            where T1 : IComponent
            where T2 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
        ...
        public IEntityQuery WhereAllOf<T1, T2, T3>()
            where T1 : IComponent
            where T2 : IComponent
            where T3 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
        ...
        public IEntityQuery WhereAllOf<T1, T2, T3, T4>()
            ...
            where T2 : IComponent
            where T3 : IComponent
            where T4 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
        ...
        public IEntityQuery WhereAnyOf<T1>()
            where T1 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.Any, ComponentConfig<T1>.Config);

        public IEntityQuery WhereAnyOf<T1, T2>()
            where T1 : IComponent
            where T2 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.Any,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config
        ...
        public IEntityQuery WhereAnyOf<T1, T2, T3>()
            where T1 : IComponent
            where T2 : IComponent
            where T3 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.Any,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
        ...
        public IEntityQuery WhereAnyOf<T1, T2, T3, T4>()
            ...
            where T2 : IComponent
            where T3 : IComponent
            where T4 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.Any,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
        ...
        public IEntityQuery WhereNoneOf<T1>()
            where T1 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.None, ComponentConfig<T1>.Config);

        public IEntityQuery WhereNoneOf<T1, T2>()
            where T1 : IComponent
            where T2 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.None,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config
        ...
        public IEntityQuery WhereNoneOf<T1, T2, T3>()
            where T1 : IComponent
            where T2 : IComponent
            where T3 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.None, new[]
            {
                ComponentConfig<T1>.Config,
                ComponentConfig<T2>.Config,
                ComponentConfig<T3>.Config
        ...
        public IEntityQuery WhereNoneOf<T1, T2, T3, T4>()
            ...
            where T2 : IComponent
            where T3 : IComponent
            where T4 : IComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.None,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
        ...
        public IEntityQuery FilterBy<T1>(T1 component)
            where T1 : ISharedComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                ComponentConfig<T1>.Config,
                Data.ComponentEntityFactory.GetSharedComponentDataIndex(component));

        public IEntityQuery FilterBy<T1, T2>(T1 component1, T2 component2)
            where T1 : ISharedComponent
            where T2 : ISharedComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config
                ...
                new[]
                {
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component1),
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component2),
                });

        public IEntityQuery FilterBy<T1, T2, T3>(T1 component1, T2 component2, T3 component3)
            where T1 : ISharedComponent
            where T2 : ISharedComponent
            where T3 : ISharedComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
                ...
                new[]
                {
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component1),
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component2),
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component3)
                });
        ...
        public IEntityQuery FilterBy<T1, T2, T3, T4>(T1 component1, T2 component2, T3 component3, T4 component4)
            ...
            where T4 : ISharedComponent => new EntityQuery_ArcheType(this, EntityQueryCategory.All,
                new[]
                {
                    ComponentConfig<T1>.Config,
                    ComponentConfig<T2>.Config,
                ...
                new[]
                {
                    ...
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component2),
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component3),
                    Data.ComponentEntityFactory.GetSharedComponentDataIndex(component4)
                });
        ...
        private static SharedComponentDataIndex[] AddShareComponent(SharedComponentDataIndex[] sourceSharedComponents, SharedComponentDataIndex sharedComponent)
        {
            var destSharedComponents = new SharedComponentDataIndex[sourceSharedComponents.Length + 1];
        ...
        private static SharedComponentDataIndex[] AddShareComponents(SharedComponentDataIndex[] sourceSharedComponents, SharedComponentDataIndex[] sharedComponent)
        {
            var destSharedComponents = new SharedComponentDataIndex[sourceSharedComponents.Length + sharedComponent.Length];
            Array.Copy(sourceSharedComponents, destSharedComponents, sourceSharedComponents.Length);
        ...
        private static void CheckDistinctShareComponent(SharedComponentDataIndex[] sourceSharedComponents, SharedComponentDataIndex sharedComponent)
        {
            if (sourceSharedComponents.Contains(sharedComponent))
            {
                throw new EntityQueryAlreadyHasFilterException(
                    ComponentConfigs.Instance.AllSharedTypes[sharedComponent.SharedIndex]);
            }
        }

        private static void CheckDistinctShareComponents(SharedComponentDataIndex[] sourceSharedComponents, SharedComponentDataIndex[] sharedComponents)
        {
            if (sourceSharedComponents.Any(x => sharedComponents.Contains(x)))
            {
                throw new EntityQueryAlreadyHasFilterException(
                    ComponentConfigs.Instance.AllSharedTypes[sourceSharedComponents.First(x => sharedComponents.Contains(x)).SharedIndex]);
            }
        }
    }
}
