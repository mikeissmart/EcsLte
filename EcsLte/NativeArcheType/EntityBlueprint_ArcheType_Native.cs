...
{
    public class EntityBlueprint_ArcheType_Native : IEntityBlueprint
    {
        ...
        public EntityBlueprint_ArcheType_Native() => _components = new DataCache<Dictionary<ComponentConfig, IEntityBlueprintComponentData_ArcheType_Native>, EntityBlueprintData_ArcheType_Native>(
        ...
        internal unsafe ArcheTypeIndex_ArcheType_Native GetArcheTypeIndex(
            ArcheTypeFactory_ArcheType_Native archeTypeFactory,
            ...
            out EntityBlueprintData_ArcheType_Native data)
        {
            ...
            if (_isArcheTypeIndexDirty || _archeTypeIndex.IsNull || _archeTypeFactory != archeTypeFactory)
            {
                ...
                if (!archeTypeFactory.GetArcheTypeData(archeType, uniqueConfigs, out _, out _archeTypeIndex))
                    archeType.Dispose();
