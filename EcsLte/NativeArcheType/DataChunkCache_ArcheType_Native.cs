...
namespace EcsLte.NativeArcheType
{
    public class DataChunkCache_ArcheType_Native
	{
		...
		private DataChunkCache_ArcheType_Native()
        {
			_cacheQueue = new Queue<IntPtr>();
        }
		...
		public unsafe void Cache(DataChunk_ArcheType_Native* dataChunk)
        {
			_cacheQueue.Enqueue((IntPtr)dataChunk);
        }
	}
}
