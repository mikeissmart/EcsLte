...
namespace EcsLte
{
	internal class BlueprintComponent
	{
		...
		internal BlueprintComponent Clone() => new BlueprintComponent(Config, Component);
	}
	...
	public class EntityBlueprint
	{
		...
		internal int[] GetComponentPoolInexes() => _components.Keys.ToArray();

		internal BlueprintComponent[] GetBlueprintComponents() => _components.Values.ToArray();
		...
		public bool HasComponent<TComponent>() where TComponent : IComponent => _components.ContainsKey(ComponentPoolIndex<TComponent>.Config.PoolIndex);
