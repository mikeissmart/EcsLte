...
namespace EcsLte
{
	...
	public class Watcher : IEcsContext, IGetEntity
	{
		...
		public static bool operator !=(Watcher lhs, Watcher rhs) => !(lhs == rhs);
		...
		public bool Equals(Watcher other) => this == other;

		public override bool Equals(object obj) => obj is Watcher other && _data.Equals(other._data);
