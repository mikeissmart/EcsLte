...
namespace EcsLte
{
    internal class SystemSorter : IComparable<SystemSorter>
    {
        ...
        public string SystemName => SystemType.Name;

        public SystemSorter(Type systemType, SystemConfig config)
        {
        ...
        public void AddBefore(SystemSorter sorter)
        {
            _befores.Add(sorter);
            sorter._afters.Add(this);
        }

        public void AddAfter(SystemSorter sorter)
        {
            _afters.Add(sorter);
        ...
        public int CompareTo(SystemSorter other) => other == null
                ? 0
                : InAfters(other)
                    ? 1
                    : -1;
