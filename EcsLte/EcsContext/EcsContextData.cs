...
namespace EcsLte
{
	...
	internal class EcsContextData
	{
		...
		private class EntityCollection : IEntityCollection
		{
			...
			public EntityCollection() => Entities = new DataCache<Entity[], Entity[]>(
					new Entity[0],
					UpdateEntitiesCache);
			...
			public Entity[] GetEntities() => Entities.CachedData;
			...
			private static Entity[] UpdateEntitiesCache(Entity[] uncachedData) => uncachedData
