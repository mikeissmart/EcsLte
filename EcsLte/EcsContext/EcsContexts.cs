...
namespace EcsLte
{
	public static class EcsContexts
	{
		...
		public static EcsContext CreateEcsContext_Managed(string name)
		{
			return AddEcsContext(x => new EcsContext(x, new ComponentEntityFactory_Managed()), name);
		}

		public static EcsContext CreateEcsContext_ArcheType_Managed(string name)
		{
			return AddEcsContext(x => new EcsContext(x, new ComponentEntityFactory_ArcheType_Managed()), name);
		}

		public static EcsContext CreateEcsContext_Native(string name)
		{
			return AddEcsContext(x => new EcsContext(x, new ComponentEntityFactory_Native()), name);
		}

		public static EcsContext CreateEcsContext_ArcheType_Native(string name)
		{
			return AddEcsContext(x => new EcsContext(x, new ComponentEntityFactory_ArcheType_Native()), name);
		}

		public static EcsContext CreateEcsContext_ArcheType_Native_Continuous(string name)
		{
			return AddEcsContext(x => new EcsContext(x, new ComponentEntityFactory_ArcheType_Native_Continuous()), name);
		}
