...
namespace EcsLte
{
    public unsafe class EcsContext
    {
        ...
        internal void UpdateForEachArcheType(Entity entity, EntityData entityData, IComponentAdapter[] sharedComponentAdapters)
        {
            var updatedAdapters = sharedComponentAdapters
                .Where(x => x.IsUpdated);
