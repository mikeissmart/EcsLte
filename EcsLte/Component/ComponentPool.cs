...
namespace EcsLte
{
		...
		where TComponent : IComponent
	{
		...
		public bool HasComponent(int entityId) => _hasComponents[entityId];

		public IComponent GetComponent(int entityId) => _components[entityId];
		...
		public void RemoveComponent(int entityId) => _hasComponents[entityId] = false;

		public void ReplaceComponent(int entityId, IComponent component) => _components[entityId] = (TComponent)component;
