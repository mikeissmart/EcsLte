...
public class TestManagedComponent1 : IManagedComponent, ITestComponent
{
    public int Prop { get; set; }
    public string StrProp { get; set; }
}

public class TestManagedComponent2 : IManagedComponent, ITestComponent
{
    public int Prop { get; set; }
    public string StrProp { get; set; }
}

public class TestManagedComponent3 : IManagedComponent, ITestComponent
{
    public int Prop { get; set; }
    public string StrProp { get; set; }
}

public class TestManagedComponent4 : IManagedComponent, ITestComponent
{
    public int Prop { get; set; }
    public string StrProp { get; set; }
}